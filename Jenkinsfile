            ...
            post {
                always {
                    ...
                    emailext (
                        ...
                        subject: "Jenkins Notification: ${env.JOB_NAME} - ${env.BUILD_NUMBER} - Unit and Integration Test Results",
                        body: """<p>Unit and Integration Tests completed. Please find the details below:</p>
